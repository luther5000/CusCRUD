...
/**
 * Resposta HTTP do endpoint de criacao de produtos.
 * Expoe o identificador gerado e os dados principais do produto persistido.
 * Efeitos colaterais: nenhum.
 *
 * @param productId identificador gerado do produto.
