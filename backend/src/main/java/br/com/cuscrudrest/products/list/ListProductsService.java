...
/**
 * Servico de listagem paginada de produtos de um inventario.
...
public class ListProductsService {
    ...
    /**
     * Cria o servico de listagem de produtos.
     *
     ...
     * @return pagina de produtos do inventario informado.
     */
    public ListProductsPage listProducts(
        ...
        int total = productRepository.countProducts(inventoryId);
        ...
        List<ListProductsItemResponse> products = productRepository.listProducts(inventoryId, effectiveLimit, effectiveOffset)
                .stream()
